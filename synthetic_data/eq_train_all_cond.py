...
class OptNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return F.log_softmax(x), torch.linalg.cond(A)
...
if (epsilon == 0):
    ...
    if args.use_cuda == 1:
        outputDir = "cuda/model_def_eps_" + str(epsilon) + "/seed_" + str(args.seed) + "/"
    elif args.use_cuda == 0:
        outputDir = "nocuda/model_def_eps_" + str(epsilon) + "/seed_" + str(args.seed) + "/"
