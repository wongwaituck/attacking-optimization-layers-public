...
if __name__=="__main__":
    ...
    parser.add_argument("-l", "--logdir",help="Directory to save logs to, together with data", default="./cond_atk_loss_fn_maxPGD_alt/")
    ...
    for i in range(1, 2):
        ...
        for idx, img in enumerate(train_loader):
            ...
            for t in range(1, EPOCHS + 1):
                ...
                loss = -torch.sum(torch.abs(y_pred))
                if t%PRINT_FREQ == 0:
                    print(f"[*] Model {i} image {idx} loss from attack steps ", t, -loss.item())
                ...
                if math.isnan(loss):
                    ...
                    im = transforms.ToPILImage()(torch.clamp(current_x + delta, 0, 1)[0])
