...
class Net(nn.Module):
    def __init__(self, outputShape, epsilon):
...
if __name__=="__main__":
    ...
    parser.add_argument("-n", "--epochs", help="Number of Epochs to train", type=int, default=20)
    ...
    parser.add_argument("-m", "--modeldir",help="Directory to save model checkpoints to, together with data", default="./model_def")
    parser.add_argument("-r", "--seed", help="Random seed to use", type=int, default=2)
    parser.add_argument("-e", "--epsilon", help="Epsilon (ratio of singular value) to use", type=float, default=10.0)
